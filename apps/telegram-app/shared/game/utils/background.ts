...
export class BackgroundGenerator {
  ...
  constructor(app: Application) {
    ...
    this.#changePaletteByVariant('GREEN')
    this.#changePalette()
  }

  #changePaletteByVariant(variant: ChunkVariant) {
    if (variant === 'GREEN') {
  ...
  public async generate(data: { width: number, height: number, variant: ChunkVariant }) {
    this.#changePaletteByVariant(data.variant)
    ...
    return new TilingSprite({ texture, width: 1800, height: 1800 })
  }
